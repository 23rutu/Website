...
document.getElementById("eventSelect").addEventListener("change", function() {
    ...
    switch (selectedEvent) {
        case "hackathon":
            window.location.href = "1culreg form.html";
            break;
        case "coding":
            window.location.href = "2culreg form.html";
            break;
        case "logic":
            window.location.href = "3culreg form.html";
            break;
        case "escape":
            window.location.href = "4culreg form.html";
            break;
        default:
